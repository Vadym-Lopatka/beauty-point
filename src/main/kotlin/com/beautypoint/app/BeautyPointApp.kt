...
class BeautyPointApp(private val env: Environment) : InitializingBean {

    private val log = LoggerFactory.getLogger(BeautyPointApp::class.java)

    /**
     * Initializes beautyPoint.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<BeautyPointApp>(*args) {
        ...
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(BeautyPointApp::class.java)
