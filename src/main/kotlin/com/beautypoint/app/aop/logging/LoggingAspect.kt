package com.beautypoint.app.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut("within(com.beautypoint.app.repository..*)" +
        " || within(com.beautypoint.app.service..*)" +
        " || within(com.beautypoint.app.web.rest..*)")
