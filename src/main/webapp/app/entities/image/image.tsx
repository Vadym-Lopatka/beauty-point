...
export interface IImageState extends IPaginationBaseState {
  search: string;
}
...
export class Image extends React.Component<IImageProps, IImageState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="image-heading">
          <Translate contentKey="beautyPointApp.image.home.title">Images</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="beautyPointApp.image.home.createLabel">Create new Image</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('beautyPointApp.image.home.search')}
                  />
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('source')}>
                    <Translate contentKey="beautyPointApp.image.source">Source</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('imageType')}>
                    <Translate contentKey="beautyPointApp.image.imageType">Image Type</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="beautyPointApp.image.owner">Owner</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {imageList.map((image, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{image.source}</td>
                    <td>
                      <Translate contentKey={`beautyPointApp.ImageTypeEnum.${image.imageType}`} />
                    </td>
                    <td>{image.owner ? image.owner.login : ''}</td>
